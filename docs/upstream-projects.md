...
|---|---|---|---|---|
| **Pi coding-agent harness and AI schema utilities** `@earendil-works/pi-coding-agent@0.80.6`, `@earendil-works/pi-ai@0.80.6` | [`earendil-works/pi`, commit `2b3fda9…`](https://github.com/earendil-works/pi/commit/2b3fda9921b5590f285165287bd442a25817f17b) · [coding-agent registry](https://registry.npmjs.org/@earendil-works%2Fpi-coding-agent/0.80.6) · [pi-ai registry](https://registry.npmjs.org/@earendil-works%2Fpi-ai/0.80.6) | Package metadata: **Mario Zechner**; current repository home: **Earendil Works**; npm maintainer handles include `mitsuhiko`, `badlogic`, and `rwachtler` | MIT in registry and exact root [`LICENSE`](https://raw.githubusercontent.com/earendil-works/pi/2b3fda9921b5590f285165287bd442a25817f17b/LICENSE) | Supplies the agent harness and schema helper used by the lean tool. I selected, isolated, configured, locally integration-patched, and verified it; I did not author Pi. |
